...
- **Cost per run** ([#9](https://github.com/justinnewbold/fractal-remote/pull/9)).
  Each run sends the full model roster plus every placed block's parameter
  schema, so input tokens scale with the preset.
- **Diagnostics panel** ([#8](https://github.com/justinnewbold/fractal-remote/pull/8)).
...
- **Normalised writes** ([#7](https://github.com/justinnewbold/fractal-remote/pull/7)).
...
- **`continuous: false`** ([#6](https://github.com/justinnewbold/fractal-remote/pull/6)).
...
- **Gain staging off limits** ([#4](https://github.com/justinnewbold/fractal-remote/pull/4)).
...
## 2.1.0 — control ([#5](https://github.com/justinnewbold/fractal-remote/pull/5))
...
## 2.0.0 — the rewrite ([#1](https://github.com/justinnewbold/fractal-remote/pull/1), [#2](https://github.com/justinnewbold/fractal-remote/pull/2), [#3](https://github.com/justinnewbold/fractal-remote/pull/3))
